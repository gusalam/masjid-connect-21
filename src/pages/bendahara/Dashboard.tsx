...
import { DollarSign, TrendingUp, TrendingDown, FileText, PlusCircle, CheckCircle, Package } from "lucide-react";
...
export default function BendaharaDashboard() {
  ...
  return (
    <div className="p-6 space-y-8">
      {/* Page Header */}
      <div className="bg-gradient-to-r from-accent to-primary text-primary-foreground p-6 rounded-xl shadow-lg">
      ...
      <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-4">
        <Link to="/bendahara/input-pemasukan">
          <Button size="lg" className="w-full h-20 gradient-primary text-primary-foreground font-semibold">
            <PlusCircle className="w-5 h-5 mr-2" />
            Input Pemasukan
          </Button>
        </Link>
        <Link to="/bendahara/input-pengeluaran">
          <Button size="lg" variant="outline" className="w-full h-20 border-2 font-semibold">
            <TrendingDown className="w-5 h-5 mr-2" />
            Input Pengeluaran
          </Button>
        </Link>
        <Link to="/bendahara/inventaris">
          <Button size="lg" variant="outline" className="w-full h-20 border-2 font-semibold">
            <Package className="w-5 h-5 mr-2" />
            Kelola Inventaris
          </Button>
        </Link>
        <Link to="/bendahara/buat-laporan">
          <Button size="lg" variant="outline" className="w-full h-20 border-2 font-semibold">
